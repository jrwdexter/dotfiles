...
keys.globalkeys = gears.table.join(
  ...
  -- Hotkey help
  awful.key({ superkey }, "/", hotkeys_popup.show_help, { description = "hotkey help", group = "awesome" }),
  ...
  -- the browser
  awful.key({ superkey }, "i", apps.todo_input, { description = "markdown scratchpad", group = "launcher" }),
  awful.key(
    { superkey, shiftkey },
    "i",
    apps.markdown_input,
  ...
  -- Email
  awful.key({ superkey, ctrlkey }, "e", apps.mail, { description = "email", group = "launcher" }),
  -- Quick edit file
